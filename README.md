...
- <img src="https://pypi.org/static/images/logo-small.2a411bc6.svg" height="14"/> [MEOK Injection Scanner](https://github.com/CSOAI-ORG/meok-mcp-injection-scan-mcp) - Scans MCP tool descriptions for prompt injection, SSRF, and data exfiltration patterns. Covers known CVEs and OWASP risks specific to MCP deployments.
