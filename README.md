...
- [AI BOM](https://github.com/CSOAI-ORG/ai-bom-mcp) - AI Bill of Materials for ML/AI systems. Generate SPDX-compliant AI BOMs, dependency graphs, model cards, and supply-chain risk assessments. `pip install ai-bom-mcp`
- [AI Incident Reporting](https://github.com/CSOAI-ORG/ai-incident-reporting-mcp) - EU AI Act Article 62 incident reporting. Structured incident intake, severity scoring, and regulatory notification drafts. `pip install ai-incident-reporting-mcp`
- [AI Self-Audit](https://github.com/CSOAI-ORG/ai-self-audit-mcp) - Automated AI system self-assessment. 42-point audit, bias detection, transparency scoring, and compliance gap analysis. `pip install ai-self-audit-mcp`
- [Bias Detection](https://github.com/CSOAI-ORG/bias-detection-mcp) - AI fairness and bias detection. Statistical parity, equalized odds, disparate impact analysis, and remediation recommendations. `pip install bias-detection-mcp`
- [Care Membrane](https://github.com/CSOAI-ORG/care-membrane-mcp) - AI safety membrane for MCP tool chains. Intent classification, action gating, ethical boundary enforcement, and audit logging. `pip install care-membrane-mcp`
- [CRA Annex IV Classifier](https://github.com/CSOAI-ORG/meok-cra-annex-iv-classifier-mcp) - EU Cyber Resilience Act Annex IV classification. Product categorisation, conformity assessment routing, and documentation requirements. `pip install meok-cra-annex-iv-classifier-mcp`
- [CRA Compliance](https://github.com/CSOAI-ORG/cra-compliance-mcp) - EU Cyber Resilience Act compliance toolkit. Vulnerability handling, SBOM generation, CE marking, and reporting obligations. `pip install cra-compliance-mcp`
- [DORA Compliance](https://github.com/CSOAI-ORG/dora-compliance-mcp) - EU Digital Operational Resilience Act compliance. ICT risk management, incident reporting, third-party oversight, and resilience testing. `pip install dora-compliance-mcp`
- [DORA NIS2 Crosswalk](https://github.com/CSOAI-ORG/dora-nis2-crosswalk-mcp) - DORA-to-NIS2 regulatory crosswalk. Map overlapping requirements, identify gaps, and generate unified compliance matrices. `pip install dora-nis2-crosswalk-mcp`
- [EU AI Act Compliance](https://github.com/CSOAI-ORG/eu-ai-act-compliance-mcp) - EU AI Act compliance for AI agents. Risk classification, 42-point audit, documentation generator, penalty calculator, and deadline tracker. `pip install eu-ai-act-compliance-mcp`
- [NIS2 Compliance](https://github.com/CSOAI-ORG/nis2-compliance-mcp) - EU NIS2 Directive compliance. Essential/important entity classification, security measures audit, incident reporting, and supply-chain requirements. `pip install nis2-compliance-mcp`
- [Omnibus Tracker](https://github.com/CSOAI-ORG/meok-omnibus-tracker-mcp) - EU AI Act Omnibus Amendment tracker. Monitor legislative changes, impact assessments, and updated compliance deadlines. `pip install meok-omnibus-tracker-mcp`
- [UK AI Bill Compliance](https://github.com/CSOAI-ORG/uk-ai-bill-compliance-mcp) - UK AI Safety Bill compliance. Regulatory sandbox readiness, safety case requirements, and UK-EU regulatory divergence analysis. `pip install uk-ai-bill-compliance-mcp`
- [Watermark Attestation](https://github.com/CSOAI-ORG/meok-watermark-attest-mcp) - AI content watermarking and provenance attestation. C2PA-compatible watermark embedding, verification, and chain-of-custody tracking. `pip install meok-watermark-attest-mcp`
